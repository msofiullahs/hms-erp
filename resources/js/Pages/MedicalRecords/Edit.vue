...
<template>
    <AppLayout :title="`Edit ${props.record.mrn}`">
        <Head :title="`Edit ${props.record.mrn}`" />
        ...
        <div class="mx-auto max-w-4xl">
            ...
            <MedicalRecordForm :record="props.record" :submit-url="route('medicalrecords.update', props.record.id)" method="put" />
        </div>
    </AppLayout>
</template>
